module game {
    ...
    export class shop_listMediator extends puremvc.Mediator implements puremvc.IMediator {
        ...
        public constructor(viewComponent: any) {
            ...
            this.shop_list.addEventListener(egret.Event.ADDED_TO_STAGE, this.initData, this);
            this.initData();
        }
        ...
        public haha() {
            this.sendNotification(shop_listMediator.HAHAHAH, this.shop_list.pay_money.text);            
        }        
